            ...
            <input  value="store" type="hidden" name="store">
                <div class="my-grid-container-3-columns">
                    ...
                    <div class="my-grid-item">
                        ...
                        <input required type="text" required class="form-control" name="name" placeholder="Supllier Name"  autocomplete="off">
                    </div>
                
                    <div class="my-grid-item">
                        <label class="input-labels" >Contact</label>
                        <input required type="text" required class="form-control" placeholder="Contact" name="contact"  autocomplete="off">
                    </div>
                    
                    <div class="my-grid-item">
                        <label class="input-labels" >Area</label>
                        <input required type="text" required class="form-control"  placeholder="Area " name="area"  autocomplete="off">
                    </div>
